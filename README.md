# pp_cmd_filter_and_beautify
Postprocessing command "filter_and_beautify"
...
### Test filter_and_beautify
Use `pp` to test filter_and_beautify command:  
```bash
pp
Storage directory is /tmp/pp_cmd_test/storage
Commmands directory is /tmp/pp_cmd_test/pp_cmd
query: | otl_v1 <# makeresults count=100 #> |  filter_and_beautify 
```
# pp_cmd_filter_and_beautify
